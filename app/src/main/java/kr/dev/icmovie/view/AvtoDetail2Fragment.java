...
import kr.dev.icmovie.databinding.FragmentAvtoDetail2Binding;
import kr.dev.icmovie.models.AvtoData;

public class AvtoDetail2Fragment extends Fragment implements OnclickItemPo {
    ...
    private FragmentAvtoDetail2Binding binding;

    private List<AvtoData> avtoDataList;

    public AvtoDetail2Fragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAvtoDetail2Binding.inflate(inflater, container,false);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        avtoAdapter = new AvtoAdapter(avtoDataList, this);

        binding.rvDatail.setAdapter(avtoAdapter);
...
//
        Type token = new TypeToken<AvtoData>(){}.getType();
        avtoData= gson.fromJson(sharedPreferences.getString("avtodata", "{}"),token);

//        binding.vvMusic.setImageResource(musicData.getMusicImage());
        binding.tvMusicName1.setText(avtoData.getMusicName());
        binding.tvInfoTitle.setText(avtoData.getAccountName());
        binding.tvRatingDetail.setText(avtoData.getViewNum());
