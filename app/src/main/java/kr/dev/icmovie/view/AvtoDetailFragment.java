...
public class AvtoDetailFragment extends Fragment  implements OnclickItemPo {
    ...
    private FragmentAvtoDetailBinding binding;

    private List<AvtoData> avtoDataList;

    public AvtoDetailFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAvtoDetailBinding.inflate(inflater, container,false);
...
//        binding.vvMusic.setImageResource(musicData.getMusicImage());
    ...
    public void clickItem(int position) {
        ...
        Navigation.findNavController(binding.getRoot()).navigate(R.id.avtoDetail2Fragment);
    }
